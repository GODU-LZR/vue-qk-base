...
const apps = [
    ...
    {
        name: 'user-module',
        entry: 'http://localhost:3003', // 假路径
        container: '#micro-container',
        activeRule: '/user'
    },
    {
        name: 'venue-module',
        entry: 'http://localhost:3004', // 假路径
        container: '#micro-container',
        activeRule: '/venue'
    },
    {
        name: 'equipment-module',
        entry: 'http://localhost:3005', // 假路径
        container: '#micro-container',
        activeRule: '/equipment'
    },
    {
        name: 'events-module',
        entry: 'http://localhost:3006', // 假路径
        container: '#micro-container',
        activeRule: '/events'
    },
    {
        name: 'finance-module',
        entry: 'http://localhost:3007', // 假路径
        container: '#micro-container',
        activeRule: '/finance'
    },
    {
        name: 'hr-module',
        entry: 'http://localhost:3008', // 假路径
        container: '#micro-container',
        activeRule: '/hr'
    },
    // ...更多模块
